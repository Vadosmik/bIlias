...
import logo from '@/public/images/Bilias_W.svg';
	...
	return (
		<aside className='w-64 flex flex-col h-full bg-brand-navy text-white transition-all duration-300'>
			...
			<div className='p-6 flex flex-col items-center justify-center gap-3'>
				<Image src={logo} alt='logo bilias' />
					...
					return (
						<Link
							...
							className={cn(
								...
								isActive
									? 'bg-brand-sand text-brand-light font-semibold'
							...
							<item.icon
								className={cn(
									...
									isActive
										? 'text-brand-light'
										: 'text-white/40 group-hover:text-brand-sand',
								)}
							/>
